        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.errorMessage}>
                    {this.state.errorMessage && <Text style={styles.console.error}>{this.state.errorMessage}</Text>}
                </View>
                ...
                >
                    <Text style={{color: "#414959", fontSize: 13}}>
                        New to ComCharity? <Text style={{fontWeight: "500", color: '#E9446A'}}>Sign Up</Text>
                    </Text>
                </TouchableOpacity>
            </View>
        );
